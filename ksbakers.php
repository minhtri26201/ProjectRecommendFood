...
<link rel="stylesheet" href="view/css/ksbakers.css">
...
<nav class="sidebar">
    <div class="text">
    <a href="./ksbakers.php"><i class="fa fa-home"></i></a>
    <ul>
        ...
        <li><a href="#sandwich" onclick="mysandwich()">Sandwich</a></li>
        <li><a href="#nonpizza" onclick="mypizza()">Pizza</a></li>
...
<section class="home" id="home">
    <div class="barb">
    <h2><img src="./view/images/Restaurants/ksbakers.png" height="150"></h2>
    <div class="cont">
...
<section class="brd" id="bread">
    ...
    <div class="box-bread">
    <?php
        foreach($DB->get_list("SELECT * FROM tbl_product WHERE categoryID='15'") as $product){
...
<section class="sand" id="sandwich">
    <h2 class="ks">KS Bakers</h2>
    <hr class="line">
    <h4>Sandwich</h4>  
    <div class="box-sandwich">
    <?php
        foreach($DB->get_list("SELECT * FROM tbl_product WHERE categoryID='16'") as $product){
        $product_id = $product['productID'];
        $img = $DB->get_row("SELECT * FROM `tbl_product_image` WHERE `productID` = $product_id")['productImage'];
?>
...
<section class="burg" id="burger">
    ...
    <?php
        foreach($DB->get_list("SELECT * FROM tbl_product WHERE categoryID='17'") as $product){
        $product_id = $product['productID'];
        $img = $DB->get_row("SELECT * FROM `tbl_product_image` WHERE `productID` = $product_id")['productImage'];
?>
...
<section class="past" id="pastry">
    ...
    <?php
        foreach($DB->get_list("SELECT * FROM tbl_product WHERE categoryID='18'") as $product){
        $product_id = $product['productID'];
        $img = $DB->get_row("SELECT * FROM `tbl_product_image` WHERE `productID` = $product_id")['productImage'];
?>
...
<section class="choco" id="chococake">
    <h2 class="ks">KS Bakers</h2>
    <hr class="line">
    <h4>Choclate cakes</h4>  
    <div class="box-choco">
    <?php
        foreach($DB->get_list("SELECT * FROM tbl_product WHERE categoryID='19'") as $product){
        $product_id = $product['productID'];
        $img = $DB->get_row("SELECT * FROM `tbl_product_image` WHERE `productID` = $product_id")['productImage'];
?>
...
<section class="pre" id="precakes">
    <h2 class="ks">KS Bakers</h2>
    <hr class="line">
    <h4>Premium Cakes</h4>  
    <div class="box-precake">
    <?php
        foreach($DB->get_list("SELECT * FROM tbl_product WHERE categoryID='20'") as $product){
        $product_id = $product['productID'];
        $img = $DB->get_row("SELECT * FROM `tbl_product_image` WHERE `productID` = $product_id")['productImage'];
?>
...
<section class="nonveg" id="nonpizza">
    <h2 class="dominos">Domino's</h2>
    <hr class="line">
    <h4>Pizza</h4> 
    <div class="box-nonpizza">
    <?php
        foreach($DB->get_list("SELECT * FROM tbl_product WHERE categoryID='21'") as $product){
        $product_id = $product['productID'];
        $img = $DB->get_row("SELECT * FROM `tbl_product_image` WHERE `productID` = $product_id")['productImage'];
?>
...
<section class="meh" id="cakes">
    ...
    <?php
        foreach($DB->get_list("SELECT * FROM tbl_product WHERE categoryID='22'") as $product){
        $product_id = $product['productID'];
        $img = $DB->get_row("SELECT * FROM `tbl_product_image` WHERE `productID` = $product_id")['productImage'];
?>
