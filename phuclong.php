...
<link rel="stylesheet" href="view/css/phuclong.css">
...
<nav class="sidebar">
    <div class="text">
    <a href="phuclong.php"><i class="fa fa-home"></i></a>
    <ul>
        <li><a href="#BAKERY" onclick="myBAKERY()">BAKERY'S</a></li>
        <li><a href="#Tea" onclick="myTea()">Tea</a></li>
        <li><a href="#MilkeTea" onclick="myMilkeTea()">Milke Tea</a></li>
        <li><a href="#coffee" onclick="mycoffee()">Coffee</a></li>
    </ul>
</div>
</nav>
<!--Side bar ends-->
<section class="home" id="home">
    <div class="barb">
    <h2><img src="view/images/Restaurants/phuclong1.jpg" height="350"></h2>
    <div class="cont">
        <iframe width="420" height="315"
src="https://www.youtube.com/embed/Z6Dx-o3vfJY?autoplay=1&mute=1&loop=1&controls=0&playlist=Z6Dx-o3vfJY&loop=1">
</iframe>
        </div>
        </div>
</section>
<section class="coffee" id="coffee">
    <h2 class="phuclong">phuc long</h2>
    <hr class="line">
    <h4>Coffee</h4> 
    <div class="box-coffee">
    <?php
        foreach($DB->get_list("SELECT * FROM tbl_product WHERE categoryID='3'") as $product){
...
<section class="MilkeTea" id="MilkeTea">
    <h2 class="MilkeTea">Milke Tea</h2>
    <hr class="line">
    <h4>Milke Tea</h4> 
    <div class="box-MilkeTea">
    <?php
        foreach($DB->get_list("SELECT * FROM tbl_product WHERE categoryID='4'") as $product){
        $product_id = $product['productID'];
        $img = $DB->get_row("SELECT * FROM `tbl_product_image` WHERE `productID` = $product_id")['productImage'];
    ?>
        <div class="box">
...
<section class="Tea" id="Tea">
    ...
    <div class="box-Tea">
    <?php
        foreach($DB->get_list("SELECT * FROM tbl_product WHERE categoryID='5'") as $product){
        $product_id = $product['productID'];
        $img = $DB->get_row("SELECT * FROM `tbl_product_image` WHERE `productID` = $product_id")['productImage'];
    ?>
        <div class="box">
...
<section class="BAKERY" id="BAKERY">
    <h2 class="BAKERY">BAKERY</h2>
    <hr class="line">
    <h4>BAKERY</h4>  
    <div class="box-container">
    <?php
        foreach($DB->get_list("SELECT * FROM tbl_product WHERE categoryID='6'") as $product){
        $product_id = $product['productID'];
        $img = $DB->get_row("SELECT * FROM `tbl_product_image` WHERE `productID` = $product_id")['productImage'];
    ?>
        <div class="box">
...
function myBAKERY(){
document.getElementById("BAKERYi").style.display="block";
}
function myTea(){
document.getElementById("Tea").style.display="block";
}
function myMilkeTea(){
document.getElementById("MilkeTea").style.display="block";
}
function mycoffee(){
