...
<link rel="stylesheet" href="view/css/vantilu.css">
...
<nav class="sidebar">
    <div class="text">
    <a href="./vantilu.php"><i class="fa fa-home"></i></a>
    <ul>
...
<section class="home" id="home">
    <div class="barb">
    <h2><img src="./view/images/Restaurants/vantilu.jpeg" height="150"></h2>
    <div class="cont">
