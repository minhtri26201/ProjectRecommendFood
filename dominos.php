...
<link rel="stylesheet" href="view/css/dominos.css">
...
<nav class="sidebar">
    <div class="text">
    <a href="./dominos.php"><i class="fa fa-home"></i></a>
    <ul>
        <li><a href="#pizza" onclick="myfun()">Veg Pizza</a></li>
        <li><a href="#nonpizza" onclick="myfunction()">Non-veg Pizza</a></li>
        <li><a href="#Mania" onclick="myroti()">Pizza Mania</a></li>
...
<section class="home" id="home">
    <div class="barb">
    <h2><img src="view/images/Restaurants/dominos_social_logo.jpg" height="350"></h2>
    <div class="cont">
        <iframe width="420" height="315"
src="https://www.youtube.com/embed/watch?autoplay=1&mute=1&loop=1&playlist=B9KVFppq3CA&loop=1">
</iframe>
        </div>
        </div>
</section>
...
<section class="pizzamania" id="mania">
    ...
    <div class="box-mania">
    <?php
        foreach($DB->get_list("SELECT * FROM tbl_product WHERE categoryID='7'") as $product){
...
<section class="nonveg" id="nonpizza">
    ...
    <?php
        foreach($DB->get_list("SELECT * FROM tbl_product WHERE categoryID='8'") as $product){
        $product_id = $product['productID'];
        $img = $DB->get_row("SELECT * FROM `tbl_product_image` WHERE `productID` = $product_id")['productImage'];
?>
...
<section class="veg" id="pizza">
    <h2 class="dominos">Dominos</h2>
    <hr class="line">
    <h4>Veg-Pizza</h4>  
    <div class="box-container">
    <?php
        foreach($DB->get_list("SELECT * FROM tbl_product WHERE categoryID='9'") as $product){
        $product_id = $product['productID'];
        $img = $DB->get_row("SELECT * FROM `tbl_product_image` WHERE `productID` = $product_id")['productImage'];
?>
