...
<link rel="stylesheet" href="view/css/platform65.css">
...
<nav class="sidebar">
    <div class="text">
    <a href="./platform65.php"><i class="fa fa-home"></i></a>
    <ul>
        ...
        <li><a href="#tandoori" onclick="mytandoori()">Tandoori</a></li>
    </ul>
</div>
</nav>
<!--Side bar ends-->
<section class="home" id="home">
    <div class="barb">
    <h2><img src="./view/images/Restaurants/about_platform65.jpg" height="150"></h2>
    <div class="cont">
...
<section class="tandoori1" id="tandoori">
    <h2 class="platform65">platform65</h2>
    <hr class="line">
    <h4>Tandoori </h4> 
